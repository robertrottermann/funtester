...
class FullGammut(unittest.TestCase):
    ...
    def test_full_gammut(self):
        ...
        driver.find_element_by_xpath(
            "(.//*[normalize-space(text()) and normalize-space(.)='Contacts'])[1]/following::span[1]"
        ).click()
        driver.implicitly_wait(1)
        driver.find_element_by_xpath(
            "(.//*[normalize-space(text()) and normalize-space(.)='Discard'])[1]/following::button[1]"
        ).click()
        driver.implicitly_wait(1)
        ...
        driver.find_element_by_xpath(
            "(.//*[normalize-space(text()) and normalize-space(.)='Active'])[4]/following::td[1]"
        ).click()
        ...
        driver.find_element_by_xpath(
            "(.//*[normalize-space(text()) and normalize-space(.)='Name'])[6]/following::span[1]"
        ).click()
        ...
        driver.find_element_by_xpath(
            "(.//*[normalize-space(text()) and normalize-space(.)='BFS Nationality ID'])[1]/following::span[1]"
        ).click()
        Select(driver.find_element_by_id("o_field_input_414")).select_by_visible_text(
            "Male"
        )
        driver.find_element_by_id("o_field_input_414").click()
        driver.find_element_by_xpath(
            "(.//*[normalize-space(text()) and normalize-space(.)='Gender'])[1]/following::td[2]"
        ).click()
        driver.find_element_by_id("o_field_input_415").click()
        driver.find_element_by_xpath(
            "(.//*[normalize-space(text()) and normalize-space(.)='Discard'])[3]/following::th[1]"
        ).click()
        driver.find_element_by_xpath(
            "(.//*[normalize-space(text()) and normalize-space(.)='Discard'])[3]/following::th[1]"
        ).click()
        ...
        driver.find_element_by_xpath(
            "(.//*[normalize-space(text()) and normalize-space(.)='Sa'])[1]/following::td[11]"
        ).click()
        driver.find_element_by_id("o_field_input_415").click()
        driver.find_element_by_xpath("//th/span").click()
        ...
        Select(driver.find_element_by_id("o_field_input_423")).select_by_visible_text(
            "German / Deutsch"
        )
        ...
        driver.find_element_by_xpath(
            "(.//*[normalize-space(text()) and normalize-space(.)='Address Type'])[1]/following::tr[1]"
        ).click()
        ...
        driver.find_element_by_xpath(
            u"(.//*[normalize-space(text()) and normalize-space(.)='​'])[37]/following::label[1]"
        ).click()
        ...
        driver.find_element_by_xpath(
            "(.//*[normalize-space(text()) and normalize-space(.)='Create and edit'])[3]/following::span[1]"
        ).click()
        driver.find_element_by_xpath(
            "(.//*[normalize-space(text()) and normalize-space(.)='Create and edit'])[2]/following::span[1]"
        ).click()
        driver.find_element_by_xpath(
            "(.//*[normalize-space(text()) and normalize-space(.)='Create a Country'])[1]/following::button[1]"
        ).click()
        driver.find_element_by_id("o_field_input_613").click()
        driver.find_element_by_id("o_field_input_613").clear()
        driver.find_element_by_id("o_field_input_613").send_keys("Switzerland")
        ...
        driver.find_element_by_xpath(
            "(.//*[normalize-space(text()) and normalize-space(.)='Create and edit'])[1]/following::span[1]"
        ).click()
        driver.find_element_by_id("o_field_input_613").click()
        driver.find_element_by_id("o_field_input_613").clear()
        driver.find_element_by_id("o_field_input_613").send_keys("Switzerland")
        driver.find_element_by_xpath(
            u"(.//*[normalize-space(text()) and normalize-space(.)='×'])[2]/following::div[5]"
        ).click()
        driver.find_element_by_xpath(
            "(.//*[normalize-space(text()) and normalize-space(.)='Country'])[1]/following::span[1]"
        ).click()
        driver.find_element_by_xpath(
            "(.//*[normalize-space(text()) and normalize-space(.)='Matthias'])[1]/following::span[2]"
        ).click()
        ...
        Select(driver.find_element_by_id("o_field_input_631")).select_by_visible_text(
            "Summer"
        )
        ...
        driver.find_element_by_xpath(
            "(.//*[normalize-space(text()) and normalize-space(.)='Study Course'])[8]/following::button[1]"
        ).click()
        ...
        Select(driver.find_element_by_id("o_field_input_651")).select_by_visible_text(
            "Summer"
        )
        driver.find_element_by_id("o_field_input_651").click()
        driver.find_element_by_xpath(
            "(.//*[normalize-space(text()) and normalize-space(.)='Study Course'])[8]/following::span[1]"
        ).click()
        ...
        driver.find_element_by_xpath(
            "(.//*[normalize-space(text()) and normalize-space(.)='Create'])[1]/following::button[1]"
        ).click()
        ...
        driver.find_element_by_id("o_field_input_668").send_keys(
            "Der Leberschaden schadet der Leber"
        )
        driver.find_element_by_xpath(
            "(.//*[normalize-space(text()) and normalize-space(.)='reason exmatriculation'])[1]/following::label[1]"
        ).click()
        driver.find_element_by_xpath(
            "(.//*[normalize-space(text()) and normalize-space(.)='Immatriculation Date'])[2]/following::span[1]"
        ).click()
        driver.find_element_by_xpath(
            "(.//*[normalize-space(text()) and normalize-space(.)='Create'])[1]/following::button[1]"
        ).click()
        driver.find_element_by_xpath(
            "(.//*[normalize-space(text()) and normalize-space(.)='Action'])[1]/following::span[5]"
        ).click()
        driver.find_element_by_xpath(
            "(.//*[normalize-space(text()) and normalize-space(.)='Print'])[1]/following::button[1]"
        ).click()
        driver.find_element_by_xpath(
            "(.//*[normalize-space(text()) and normalize-space(.)='False'])[1]/following::div[2]"
        ).click()
        driver.find_element_by_xpath(
            "(.//*[normalize-space(text()) and normalize-space(.)='Student Semester'])[2]/following::a[1]"
        ).click()
        ...
        driver.find_element_by_xpath(
            "(.//*[normalize-space(text()) and normalize-space(.)='False'])[1]/following::button[1]"
        ).click()
